...
void testPositionOf() {
	...
	assert(m.positionOf(10) == make_pair(-1, -1));
	...
	assert(m.positionOf(10) == make_pair(1, 1));
	assert(m.positionOf(20) == make_pair(2, 2));
	assert(m.positionOf(30) == make_pair(3, 3));


	m.modify(4, 4, 10);


	pair<int, int> pos = m.positionOf(10);
	assert((pos == make_pair(1, 1) || pos == make_pair(4, 4)));


	m.modify(1, 1, NULL_TELEM);
	assert(m.positionOf(10) == make_pair(4, 4));


	m.modify(4, 4, NULL_TELEM);
	assert(m.positionOf(10) == make_pair(-1, -1));


	assert(m.positionOf(99) == make_pair(-1, -1));
